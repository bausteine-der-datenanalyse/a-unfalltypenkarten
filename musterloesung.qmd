...
Unfalldaten (Deutschland, hier aus 2022) einlesen:
...
Streckenabschnitte (Deutschland) einlesen:

```{{r}}
strecke <- read_sf("data/geo/BFStr_Netz_SK.geojson")
```

Streckenabschnitte für die hier ausgewählte Autobahn A43:
...
Streckenabschnitte in Gesamtdeutschland:
...
Unfälle ergänzen um am nächsten gelegene Autobahn:
...
Unfälle nach Autobahnen filtern:
...
**Für das wählbare Jahr wurde in dieser Musterlösung das Jahr 2022 gewählt.**

### Mit `ggplot`

Ausgewählte Autobahn (A43):
...
**Für diese Aufgabe wurde exemplarisch die Stadt Bochum verwendet.**

**Unfalldaten von drei aufeinanderfolgenden Jahren laden**
...
# Die Unfalldaten aus 2022 haben wir vorhin schon geladen (unfaelle)
...
**Unfälle in Bochum zur Ermittlung von Unfallhäufungsstellen**
...
Siehe das Kapitel *Weitere Anwendungsbeispiele* und die Datei `unfaelle_shiny.qmd`  
